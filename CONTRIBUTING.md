# Contributing to the Redirects cookbook

We are glad and grateful for you want to contribute to the Redirects cookbook! We belive the desire to shared knowledge are the first step to improve any project.

## Quick-contribute

* Create an issue on the github [issue tracker](https://github.com/rlinstorres/redirects/issues)
* Link to your patch as a rebased git branch or pull request from the ticket

I and [jailson-silva](https://github.com/jailson-silva) will review contributions and will get back to you if we have any suggestions or concerns.
